...
enum {
	...
	PM_QOS_LITTLE_CPU_FREQ_MIN,
	PM_QOS_LITTLE_CPU_FREQ_MAX,
	PM_QOS_BIG_CPU_FREQ_MIN,
	PM_QOS_BIG_CPU_FREQ_MAX,
...
#define PM_QOS_BIG_CPU_FREQ_MIN_DEFAULT_VALUE	0
#define PM_QOS_BIG_CPU_FREQ_MAX_DEFAULT_VALUE	INT_MAX
#define PM_QOS_LITTLE_CPU_FREQ_MIN_DEFAULT_VALUE	0
#define PM_QOS_LITTLE_CPU_FREQ_MAX_DEFAULT_VALUE	INT_MAX
