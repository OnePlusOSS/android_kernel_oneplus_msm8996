...
#define ZONE_LOCK_R(zone) ((spinlock_t *)((char *)zone + get_zone_offset(ZONE_OFFSET_LOCK)))
#define ZONE_ZSP_R(zone) (*(unsigned long *)((char *)zone + get_zone_offset(ZONE_OFFSET_ZSP)))
...
#define PGLIST_DATA_NODE_ZONES_R(pglist_data) ((struct zone *)((char *)pglist_data + get_pglist_data_offset(PGLIST_DATA_OFFSET_NODE_ZONES)))
